...
@property (nonatomic, strong, readonly) NSMutableArray <JCFLVVideoFrame*>* _Nonnull list;

/** buffer count max size default 1000 */
@property (nonatomic, assign) NSUInteger maxCount;

/** add frame to buffer */
- (void)appendObject:(nullable JCFLVVideoFrame*)frame;

/** pop the first frome buffer */
- (nullable JCFLVVideoFrame*)popFirstObject;
